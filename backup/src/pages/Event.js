...
function Event(props) {
    ...
    function handleBannerUploadChange(event) {
    ...
    function submitMenuItem() {
        API.updateEvent(props.eventInFocus._id, { $push: 
            { "menu": 
                { 
                    menuItem : menutItem, 
                        ...
                        <Col md={12} id="bannerCol" className="d-flex p-0 justify-content-center">
                            ...
                            {editEvent? <div id="bannerUpload">  
                                ...
                                <div className="d-flex">
                                    <input type="file" className="" onChange={handleBannerUploadChange} />
                                    <button className="h-50 btn btn-1" onClick={props.uploadBannerImage} >Submit</button>
                                </div>
                            </div> : ""}
                        </Col>
                    </Row>
                    ...
                    <Col md={8} className="my-5 mx-auto" >
                        <div className="card mx-auto" style={{ border: "none", boxShadow: "0 8px 16px 0 rgba(0,0,0,0.2)" }}>
                            <div className="card-body ">
                                ...
                                {eventAuth ?
                                <button className="btn btn1" onClick={addingMenuItem}>Add Menu Item</button>
                                : "" }
