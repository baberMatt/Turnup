...
function User(props) {
    ...
    const [displayedUser, setDisplayedUser] = useState({ Username: "user", hosting: [], attending: [], profilePicture: {imageName: "https://cdn.icon-icons.com/icons2/1378/PNG/512/avatardefault_92824.png"}  });
                ...
                <Row className="Row contentBox boxInner d-flex justify-content-around mt-5">
                    ...
                    <Col md={3} className="d-flex justify-content">
                        <div className="my-3" >
                            ...
                            <img src={`http://localhost:3001/uploads/${displayedUser.profilePicture.imageName}`} alt="upload-image" className="ml-5"  id="profileImage" />
                            {editAbout? <div>  
                                <h6 className="text-center">Upload a profile pic</h6>
                                <div className="d-flex">
                                    <input type="file" className="" onChange={handleImageUploadChange} />
                                    <button className="h-50 btn btn-1" onClick={props.uploadImage}>Submit</button>
                                </div>
                            </div> : ""}
                        </div>
                    </Col>
