...
export default {
  ...
  postImage: function (id, imageData) {
    return axios.post("/api/upload/image/" + id, imageData);
  },
  postBannerImage: function (id, imageData) {
    console.log(imageData)
    return axios.post("/api/upload/bannerImage/" + id, imageData);
  },
};